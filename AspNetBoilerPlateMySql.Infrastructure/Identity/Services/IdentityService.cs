using AspNetBoilerPlateMySql.Application.DTOs.Identity;
using AspNetBoilerPlateMySql.Application.DTOs.Mail;
using AspNetBoilerPlateMySql.Application.DTOs.Settings;
using AspNetBoilerPlateMySql.Application.Enums;
using AspNetBoilerPlateMySql.Application.Exceptions;
...
namespace AspNetBoilerPlateMySql.Infrastructure.Identity.Services
{
