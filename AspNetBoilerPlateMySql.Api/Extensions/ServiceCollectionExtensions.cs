using AspNetBoilerPlateMySql.Api.Services;
using AspNetBoilerPlateMySql.Application.DTOs.Settings;
using AspNetBoilerPlateMySql.Application.Interfaces;
...
using AspNetBoilerPlateMySql.Infrastructure.Identity.Services;
using AspNetBoilerPlateMySql.Infrastructure.Shared.Services;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\AspNetBoilerPlateMySql.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    Version = "v1",
                    Title = "AspNetBoilerPlateMySql",
