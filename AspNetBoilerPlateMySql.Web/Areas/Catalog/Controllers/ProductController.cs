using AspNetBoilerPlateMySql.Application.Constants;
...
using AspNetBoilerPlateMySql.Application.Features.Products.Commands.Delete;
...
namespace AspNetBoilerPlateMySql.Web.Areas.Catalog.Controllers
{
    [Area("Catalog")]
